...
namespace MLSandboxML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\fabio\OneDrive\Desktop\Docs\ML Test Data\sentiment labelled sentences\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\fabio\AppData\Local\Temp\MLVSTools\MLSandboxML\MLSandboxML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-05f, ConvergenceTolerance = 0.001f, NumberOfIterations = 10, Shuffle = true, LabelColumnName = "col1", FeatureColumnName = "Features" }), labelColumnName: "col1")
